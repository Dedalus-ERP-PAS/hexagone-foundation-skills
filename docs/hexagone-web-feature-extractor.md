...
Explore un espace Hexagone Web via Claude in Chrome. Capture chaque page/onglet et produit un document Word (.docx) orienté PO (Product Owner) avec descriptions fonctionnelles et captures d'écran.

## Cas d'usage

- Documenter un espace fonctionnel Hexagone Web (ex : Structures / Nomenclatures)
...
- Accès réseau au serveur Hexagone Web (URL interne)
